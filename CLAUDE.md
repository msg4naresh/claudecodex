...
Claude Code
  ...
  ↓
server.py (FastAPI)
  ├─ Provider detection (environment variables)
...
Each provider implements a consistent translation pattern:
...
This pattern makes adding new providers straightforward.
